...
# Ruta relativa al proyecto: archivo 'solicitudes.db' estará en la raíz del proyecto
...
if __name__ == "__main__":
    ...
    print("Usuario: diego, Contraseña: 123, Rol: estudiante")
    print("Usuario: dani, Contraseña: 123, Rol: admin")